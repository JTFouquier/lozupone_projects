...
library(rio)
test = import("/Volumes/JEN_DATA/autism_project/microbial_analysis/03_mapping/updated_mappings_110917/mapping_asd_dms/otu_relative_abundance/relative_otu_vectors_for_r_graphs_transposed.txt")
...
#     write_var = c(write_var,names((test[i])))
#     cat(names((test[i])))
#     cat('\t')
#     cat(correlation_test$p.value)
#     cat('\t')
#     cat(correlation_test$estimate)
#     cat('\n')
#     # 
#     # print(names(test[i]))
