...
def distance_calcs_relative_freq_asvs(custom_asv_relative_abundance_file,
                                      asv_comparison_vectors_for_r_graphs):
    with open(custom_asv_relative_abundance_file, 'r') as fin:
    ...
    # TODO use TmpFile in Python; this is lame
    vectors_for_R_file = open('tmp_tmp.txt', 'w')
